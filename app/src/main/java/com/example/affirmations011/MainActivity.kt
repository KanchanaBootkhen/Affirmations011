package com.example.affirmations011
...
import com.example.affirmations011.data.Datasource
import com.example.affirmations011.ui.theme.Affirmations011Theme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Affirmations011Theme {
